...
export default class HomeScene {
    ...
    onReady() {
        ...
        this.submitButton.addEventListener('click', () => {
            ...
            setCookie('firecup-room', room, 1);

            const name = this.nameInput.value.toUpperCase();
            setCookie('firecup-name', name, 1);

            const color = this.color;
            setCookie('firecup-color', color, 1);
        ...
        return (
            <main>
                <header class="home-header">
                    <h1 class="text-center">FireCup</h1>
                </header>
                <div class="content">
                    <section>
                        <label>
